...
@register_factor
class NonCurrentAssetGrowth12m(BaseFactor):
    """非流动资产同比增长率。"""

    name = "non_current_asset_growth_12m"
    description = "海通54：非流动资产同比增长"
    ...
    def generate_signals(
        ...
        result = non_current_assets.divide(lag.where(lag > self.min_abs_denominator)) - 1.0
